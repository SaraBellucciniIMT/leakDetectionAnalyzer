...
/**
 * This class is the AbstractDataPET class. It describes variables and methods
 * necessary for PETs associated to data objects.
 * 
 * @see #groupId it's an id that usually identifies objects in the same PET
 * @see #interpreterData(Element, Elements) this method should be implemented to
 *      describe how to identify a PET for dataobjects
 * @see #printData(DataNode) this method should be implemented to describe how
 *      the data object is printed in the specification
 * 
 * @author S. Belluccini
 *
 */
public abstract class AbstractDataPET implements IPET {
	...
	/**
	 * Returns the id that identifies this AbstractTaskPET inside the mCRL2
	 * specification
	 * 
	 * @return the id that identifies this AbstractTaskPET inside the mCRL2
	 *         specification
	 */
